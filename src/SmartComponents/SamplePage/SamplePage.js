    ...
    render() {
        ...
        if (
            ...
            if (this.props.modalData.length > 0) {
                ...
                average_time = Math.floor(
                    total_time / this.props.modalData.length
                );
            }
        }
        return (
...
class SamplePage extends Component {
    ...
    constructor(props) {
        ...
        this.server =
            'nginx-tower-analytics2.5a9f.insights-dev.openshiftapps.com';
